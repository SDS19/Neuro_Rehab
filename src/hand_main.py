...
#                     sg.Text(node_1.get_actual_position() * node_1.position_factor, size=(7, 2), font="Any 15", key="act_posi_1")],
#                    [sg.Text("Drive 2: ", size=(7, 2), font="Any 15"),
#                     sg.Text(node_2.get_actual_position() * node_2.position_factor, size=(7, 2), font="Any 15", key="act_posi_2")],
