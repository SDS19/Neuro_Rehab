...
(mp1_x_velo_list, mp1_y_velo_list, mp1_c_velo_list, mp1_x_velo_acc_mat, mp1_y_velo_acc_mat,
 mp1_op_time_n_list) = calcVeloAcc(sample_num, mp0_x, mp1_x, mp0_y, mp1_y, forward_x, forward_y)
(mp2_x_velo_list, mp2_y_velo_list, mp2_c_velo_list, mp2_x_velo_acc_mat, mp2_y_velo_acc_mat,
 mp2_op_time_n_list) = calcVeloAcc(sample_num, mp0_x, mp2_x, mp0_y, mp2_y, forward_x, forward_y)
(mp3_x_velo_list, mp3_y_velo_list, mp3_c_velo_list, mp3_x_velo_acc_mat, mp3_y_velo_acc_mat,
 mp3_op_time_n_list) = calcVeloAcc(sample_num, mp0_x, mp3_x, mp0_y, mp3_y, forward_x, forward_y)
(mp4_x_velo_list, mp4_y_velo_list, mp4_c_velo_list, mp4_x_velo_acc_mat, mp4_y_velo_acc_mat,
 mp4_op_time_n_list) = calcVeloAcc(sample_num, mp0_x, mp4_x, mp0_y, mp4_y, forward_x, forward_y)
(mp5_x_velo_list, mp5_y_velo_list, mp5_c_velo_list, mp5_x_velo_acc_mat, mp5_y_velo_acc_mat,
 mp5_op_time_n_list) = calcVeloAcc(sample_num, mp0_x, mp5_x, mp0_y, mp5_y, forward_x, forward_y)
(mp6_x_velo_list, mp6_y_velo_list, mp6_c_velo_list, mp6_x_velo_acc_mat, mp6_y_velo_acc_mat,
 mp6_op_time_n_list) = calcVeloAcc(sample_num, mp0_x, mp6_x, mp0_y, mp6_y, forward_x, forward_y)
...
frame_hand_info = [[sg.Text("Actual Position:", size=(14, 2), font="Any 20")],
                   [sg.Text("Drive 1: ", size=(7, 2), font="Any 20"),
                    sg.Text(node_1.getActualPosition() * node_1.posi_factor, size=(7, 2), font="Any 20",
                            key="act_posi_1")],
                   [sg.Text("Drive 2: ", size=(7, 2), font="Any 20"),
                    sg.Text(node_2.getActualPosition() * node_2.posi_factor, size=(7, 2), font="Any 20",
                            key="act_posi_2")],
...
hand_window_layout = [
    ...
    [sg.Frame("Drive", frame_drive, font="Any 20", title_color='black'), sg.Push(),
...
frame_cp = [[sg.Text("Control Point Mode", size=(20, 2), font="Any 20")],
            ...
            [sg.Text("Control point : ", size=(14, 2), font="Any 20"),
             sg.Combo(values=['', 1, 2, 3, 4, 5, 6], font="Any 20", key="control_point")],
...
frame_rm = [[sg.Text("Relax Mode", size=(14, 2), font="Any 20")],
            [sg.Text("Max.Angle[deg.]:", size=(20, 2), font="Any 20"),
             sg.InputText(max_angle, size=(7, 2), font="Any 20", key="max_angle")],
            [sg.Text("Step[deg.]:", size=(20, 2), font="Any 20"),
             sg.InputText(step_angle, size=(7, 2), font="Any 20", key="step_angle")],
            [sg.Text("Frequency:", size=(20, 2), font="Any 20"),
             sg.InputText(frequency, size=(7, 2), font="Any 20", key="frequency")],
            [sg.Text("Velocity:", size=(20, 2), font="Any 20"),
             sg.InputText(velo_c, size=(7, 2), font="Any 20", key="velo_c")],
...
frame_arm_info = [[sg.Text("Actual Position: ", size=(14, 2), font="Any 20")],
                  [sg.Text("Motor X: ", size=(7, 2), font="Any 20"),
                   sg.Text(act_posi_x, size=(7, 2), font="Any 20", key="act_posi_x")],
                  [sg.Text("Motor Y: ", size=(7, 2), font="Any 20"),
                   sg.Text(act_posi_y, size=(7, 2), font="Any 20", key="act_posi_y")],
...
mode_tab = [[sg.TabGroup([[sg.Tab('Contol\nPoint', frame_cp, font="Any 20"),
                           sg.Tab('Profil\nPosition', frame_pv, font="Any 20"),
                           sg.Tab('Relax', frame_rm, font="Any 20")]], tab_location='lefttop')]]
            ...
            if values["control_point"] != '':
                ...
                if values["control_point"] == 1 and event in (None, 'CP_Start'):
                    ...
                    if target_x <= 250.0 and target_x >= 0.0 and target_y <= 250.0 and target_y >= 0.0:
                        ...
                        move(abs(mp1_x - mp0_x), abs(mp1_y - mp0_y), mp1_x_velo_acc_mat, mp1_y_velo_acc_mat,
                             mp1_op_time_n_list)
