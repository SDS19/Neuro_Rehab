...
(cp1_x_velo_list, cp1_y_velo_list, cp1_c_velo_list, cp1_x_velo_acc_mat, cp1_y_velo_acc_mat, cp1_op_time_n_list) = calcVeloAcc(sample_num, cp0_x, cp1_x, cp0_y, cp1_y, forward_x, forward_y)
(cp2_x_velo_list, cp2_y_velo_list, cp2_c_velo_list, cp2_x_velo_acc_mat, cp2_y_velo_acc_mat, cp2_op_time_n_list) = calcVeloAcc(sample_num, cp0_x, cp2_x, cp0_y, cp2_y, forward_x, forward_y)
(cp3_x_velo_list, cp3_y_velo_list, cp3_c_velo_list, cp3_x_velo_acc_mat, cp3_y_velo_acc_mat, cp3_op_time_n_list) = calcVeloAcc(sample_num, cp0_x, cp3_x, cp0_y, cp3_y, forward_x, forward_y)
(cp4_x_velo_list, cp4_y_velo_list, cp4_c_velo_list, cp4_x_velo_acc_mat, cp4_y_velo_acc_mat, cp4_op_time_n_list) = calcVeloAcc(sample_num, cp0_x, cp4_x, cp0_y, cp4_y, forward_x, forward_y)
(cp5_x_velo_list, cp5_y_velo_list, cp5_c_velo_list, cp5_x_velo_acc_mat, cp5_y_velo_acc_mat, cp5_op_time_n_list) = calcVeloAcc(sample_num, cp0_x, cp5_x, cp0_y, cp5_y, forward_x, forward_y)
(cp6_x_velo_list, cp6_y_velo_list, cp6_c_velo_list, cp6_x_velo_acc_mat, cp6_y_velo_acc_mat, cp6_op_time_n_list) = calcVeloAcc(sample_num, cp0_x, cp6_x, cp0_y, cp6_y, forward_x, forward_y)
...
frame_hand_setup = [[sg.Text('Drive 1',size=(28,2), font="Any 20"), sg.Text('Drive 2',size=(14,2), font="Any 20")],
               ...
               [sg.Text("Cycle: ",font="Any 20"), sg.Input(hand_cycle, size=(7,2), font="Any 20", key ="hand_cycle"),
...
frame_hand_info = [[sg.Text("Actual Position:",size=(14,2), font="Any 15")],
              [sg.Text("Drive 1: ",size=(7,2), font="Any 15"), sg.Text(node_1.getActualPosition()*node_1.posi_factor,size=(7,2), font="Any 15", key="act_posi_1")],
              [sg.Text("Drive 2: ",size=(7,2), font="Any 15"), sg.Text(node_2.getActualPosition()*node_2.posi_factor,size=(7,2), font="Any 15", key="act_posi_2")],
...
hand_window_layout = [
                ...
                [sg.Frame("Drive", frame_hand_move, font="Any 20", title_color='black'),sg.Push(), sg.Frame("Info", frame_hand_info,font="Any 20", title_color='black'),sg.Push()],
                ]

# All the stuff inside your window.
virtual_keyboard = [[sg.Button("CP1", size=(7,2), font="Any 15", key="CP1"), sg.Button("CP2", size=(7,2), font="Any 15", key="CP2"), sg.Button("CP3", size=(7,2), font="Any 15", key="CP3")],
                    [sg.Button("CP4", size=(7,2), font="Any 15", key="CP4"), sg.Button("CP5", size=(7,2), font="Any 15", key="CP5"), sg.Button("CP6", size=(7,2), font="Any 15", key="CP6")],
                    [sg.Button("Homing", size=(7,2), font="Any 15", key="CP_Homing"), sg.Button("del", size=(7,2), font="Any 15", key="del")]
                   ]

path_select_column = [[sg.Frame("", virtual_keyboard), sg.Text("", background_color="grey80", size=(21, 10), font="Any 15", key="cp_path")]]
...
frame_dMode = [[sg.Text("Detonation Mode",size=(14, 2), font="Any 20")],
            [sg.Text("Max.Angle[deg.]:",size=(20, 2), font="Any 20"), sg.InputText(dMode_max_angle, size=(7,2), font="Any 20", key="dMode_max_angle")],
            [sg.Text("Step Angle[deg.]:",size=(20, 2), font="Any 20"), sg.InputText(dMode_step_angle, size=(7,2), font="Any 20", key="dMode_step_angle")],
            [sg.Text("Cycle:",size=(20, 2), font="Any 20"), sg.InputText(dMode_cycle, size=(7,2), font="Any 20", key="dMode_cycle")],
            [sg.Text("Velocity:",size=(20, 2), font="Any 20"), sg.InputText(dMode_velo, size=(7,2), font="Any 20", key="dMode_velo")],
...
frame_arm_info = [[sg.Text("Actual Position: ", size=(14,2), font="Any 15")],
                  [sg.Text("Motor X: ", size=(7,2), font="Any 15"), sg.Text(act_posi_x, size=(7,2), font="Any 15", key="act_posi_x")],
                  [sg.Text("Motor Y: ", size=(7,2), font="Any 15"), sg.Text(act_posi_y, size=(7,2), font="Any 15", key="act_posi_y")],
                  [sg.Button("Update", size=(14, 2), font="Any 15", button_color=('white', 'grey80'), key="arm_info_update")]]
...
mode_tab = [[sg.TabGroup([[sg.Tab('Grip\nMode', frame_gMode, font="Any 20"),sg.Tab('Parametric\nMode', frame_pMode, font="Any 20"),sg.Tab('Detonation\nMode',frame_dMode, font="Any 20")]],tab_location='lefttop')]]
